...
@section('title','Post Education Ad | PublicMarket')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="content_wrapper">
                        <h3 class="title">Post Education Ad</h3>
                        ...
                        <ul class="header_btn">
                            <li><a class="main-btn" href="#posteducation">Post Education Ad</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @include('frontend.section.ad-education')
