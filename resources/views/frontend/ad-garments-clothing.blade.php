...
@section('title','Post Garments & Clothing Ad | PublicMarket')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="content_wrapper">
                        <h3 class="title">Post Garments & Clothing Ad</h3>
                        ...
                        <ul class="header_btn">
                            <li><a class="main-btn" href="#garmentsclothing">Post Garments & Clothing Ad</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @include('frontend.section.ad-garments-clothing')
