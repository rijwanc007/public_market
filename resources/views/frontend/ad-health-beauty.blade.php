...
@section('title','Post Health & Beauty Ad | PublicMarket')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="content_wrapper">
                        <h3 class="title">Post Health & Beauty Ad</h3>
                        ...
                        <ul class="header_btn">
                            <li><a class="main-btn" href="#healthbeauty">Post Health & Beauty Ad</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @include('frontend.section.ad-health-beauty')
