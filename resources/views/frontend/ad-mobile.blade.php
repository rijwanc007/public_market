...
@section('title','Post Mobile Ad | PublicMarket')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="content_wrapper">
                        <h3 class="title">Post Mobile Ad</h3>
                        ...
                        <ul class="header_btn">
                            <li><a class="main-btn" href="#postmobile">Post Mobile Ad</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @include('frontend.section.ad-mobile')
