...
@section('title','Post Others Ad | PublicMarket')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="content_wrapper">
                        <h3 class="title">Post Others Ad</h3>
                        ...
                        <ul class="header_btn">
                            <li><a class="main-btn" href="#Others">Post Others Ad</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @include('frontend.section.ad-others')
