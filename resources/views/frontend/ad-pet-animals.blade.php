...
@section('title','Post Pet & Animals Ad | PublicMarket')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="content_wrapper">
                        <h3 class="title">Post Pet & Animals Ad</h3>
                        ...
                        <ul class="header_btn">
                            <li><a class="main-btn" href="#petanimal">Post Pet & Animals Ad</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @include('frontend.section.ad-pet-animals')
