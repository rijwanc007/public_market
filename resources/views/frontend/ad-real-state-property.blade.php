...
@section('title','Post Real State Property Ad | PublicMarket')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="content_wrapper">
                        <h3 class="title">Post Real State Property Ad</h3>
                        ...
                        <ul class="header_btn">
                            <li><a class="main-btn" href="#realstateproperty">Post Real State Property Ad</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @include('frontend.section.ad-real-state-property')
