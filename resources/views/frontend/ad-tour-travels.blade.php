...
@section('title','Post Tour Travels Ad | PublicMarket')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="content_wrapper">
                        <h3 class="title">Post Tour & Travels Ad</h3>
                        ...
                        <ul class="header_btn">
                            <li><a class="main-btn" href="#tourtravels">Post Tour & Travels Ad</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @include('frontend.section.ad-tour-travels')
