...
@section('title','Post Electronics Ad | PublicMarket')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-10">
                    <div class="content_wrapper">
                        <h3 class="title">Post Electronics Ad</h3>
                        ...
                        <ul class="header_btn">
                            <li><a class="main-btn" href="#postelectronics">Post Electronics Ad</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @include('frontend.section.ad-electronics')
