...
@section('title','Daily Needs & Grocery | PublicMarket')
@section('content')
                        ...
                        <div class="col-lg-3 col-md-5 product-search-button pb-3">
                            <div class="dropdown">
                                <button class="btn btn-light product-sort-button" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="far fa-tags drop-image"></i> &nbsp;<span>Grocery</span>
                                </button>
                        ...
                        <div class="product_list">
                            <div class="single_ads_card ads_list d-sm-flex mt-30 spotlight">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/fresh-milk.jpg')}}" alt="ads">
                                ...
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                        <p>Daily Needs & Grocery</p>
                                        <a class="like" href="#"><i class="fal fa-heart"></i></a>
                                    </div>
                                    <span class="btn-inverse-danger urgent-tag">&nbsp;&nbsp;Urgent&nbsp;&nbsp;</span>
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Fresh Milk-1 Litre</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30 spotlight">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/berry-cereal.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}"> Berry Flavoured Cereal-500gm </a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/grounded-coffee.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Fresh Grounded Coffee-200gm</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/fresh-redchilli.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Fresh Dried Red Chilli</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/dried-spice.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Dried Assorted Spices</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/garlic.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Garlic-100gm</a></h4>
