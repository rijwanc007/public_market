                        ...
                        <div class="col-lg-3 col-md-5 product-search-button pb-3">
                            <div class="dropdown">
                                <button class="btn btn-light product-sort-button" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="far fa-tags drop-image"></i> &nbsp;<span>Home & Living</span>
                                </button>
                        ...
                        <div class="product_list">
                            <div class="single_ads_card ads_list d-sm-flex mt-30 spotlight">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/sofa.jpg')}}" alt="ads">
                                ...
                                <div class="ads_card_content media-body">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Gorgeous Sofa</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30 spotlight">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/living_set.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <span class="btn-inverse-danger urgent-tag">&nbsp;&nbsp;Urgent&nbsp;&nbsp;</span>
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Living Room Chair Table Set</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/king_bed.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}"> King Size Bed</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/divine.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Divine & Leg Rest</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/dining_table.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Dining Table</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/family_bed.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Gorgeous Family Bed </a></h4>
                                    <p><i class="far fa-map-marker-alt"></i>Mymensingh, Bangladesh</p>
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.</p>
                                    <div class="ads_price_date d-flex justify-content-between">
                                        <span class="price">৳80,000.00</span>
