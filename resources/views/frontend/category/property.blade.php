...
@section('title','Property | PublicMarket')
@section('content')
                        ...
                        <div class="col-lg-3 col-md-5 product-search-button pb-3">
                            <div class="dropdown">
                                <button class="btn btn-light product-sort-button" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="far fa-tags drop-image"></i> &nbsp;<span>Property</span>
                                </button>
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseOne" role="button" aria-expanded="false" aria-controls="collapseOne"><img src="{{asset('assets/frontend/images/sidebar_icon/categories-1.svg')}}" alt="Icon"> Women's Clothing (10)</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTwo">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseTwo" role="button" aria-expanded="false" aria-controls="collapseTwo"> <img src="{{asset('assets/frontend/images/sidebar_icon/categories-2.svg')}}" alt="Icon"> Men's Clothing (87)</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingThree">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseThree" role="button" aria-expanded="false" aria-controls="collapseThree"><img src="{{asset('assets/frontend/images/sidebar_icon/categories-3.svg')}}" alt="Icon"> Telecommunications (25)</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingFour">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseFour" role="button" aria-expanded="false" aria-controls="collapseFour"><img src="{{asset('assets/frontend/images/sidebar_icon/categories-4.svg')}}" alt="Icon"> Cellphones (10078)</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingFive">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseFive" role="button" aria-expanded="false" aria-controls="collapseFive"><img src="{{asset('assets/frontend/images/sidebar_icon/categories-5.svg')}}" alt="Icon"> Computer & Office (597)</a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingSix">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false" aria-controls="collapseSix"><img src="{{asset('assets/frontend/images/sidebar_icon/categories-6.svg')}}" alt="Icon"> Consumer Electronics (27) </a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingSeven">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseSeven" role="button" aria-expanded="false" aria-controls="collapseSeven"><img src="{{asset('assets/frontend/images/sidebar_icon/categories-7.svg')}}" alt="Icon"> Jewelry & Accessories (92) </a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingEight">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseEight" role="button" aria-expanded="false" aria-controls="collapseEight"><img src="{{asset('assets/frontend/images/sidebar_icon/categories-8.svg')}}" alt="Icon"> Home & Garden (07) </a>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingNine">
                                        <a class="collapsed" data-bs-toggle="collapse" href="#collapseNine" role="button" aria-expanded="false" aria-controls="collapseNine"><img src="{{asset('assets/frontend/images/sidebar_icon/categories-9.svg')}}" alt="Icon"> Luggage & Bags (346) </a>
                                    </div>
                        ...
                        <div class="product_list">
                            <div class="single_ads_card ads_list d-sm-flex mt-30 spotlight">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/well-furnished.jpg')}}" alt="ads">
                                ...
                                <div class="ads_card_content media-body">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Well Furnished Living Space</a></h4>
                                    <p><i class="far fa-map-marker-alt"></i>Dhaka, Bangladesh</p>
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.</p>
                                    <div class="ads_price_date d-flex justify-content-between">
                                        <span class="price">৳25,999,999.00</span>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30 spotlight">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/single-office.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <span class="btn-inverse-danger urgent-tag">&nbsp;&nbsp;Urgent&nbsp;&nbsp;</span>
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Single Office Space Rent</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/agriculture-land.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}"> Agriculture Land-10 Hectre</a></h4>
                                    <p><i class="far fa-map-marker-alt"></i>Khulna, Bangladesh</p>
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.</p>
                                    <div class="ads_price_date d-flex justify-content-between">
                                        <span class="price">৳820,000.00</span>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/commercial-space.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Commercial Space For Rent</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/living-space.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Living Space For Rent</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/plot.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Plot For Sale Near Dhaka</a></h4>
                                    <p><i class="far fa-map-marker-alt"></i>Mymensingh, Bangladesh</p>
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.</p>
                                    <div class="ads_price_date d-flex justify-content-between">
                                        <span class="price">৳10,000,000.00</span>
