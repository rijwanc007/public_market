...
@section('title','Service | PublicMarket')
@section('content')
                        ...
                        <div class="col-lg-3 col-md-5 product-search-button pb-3">
                            <div class="dropdown">
                                <button class="btn btn-light product-sort-button" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="far fa-tags drop-image"></i> &nbsp;<span>Services</span>
                                </button>
                        ...
                        <div class="product_list">
                            <div class="single_ads_card ads_list d-sm-flex mt-30 spotlight">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/waiter-service.jpg')}}" alt="ads">
                                ...
                                <div class="ads_card_content media-body">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Waiter Service For Personal Functions</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/plumber.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Plumber For Home Services</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/electrician.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Electrician For Home Service</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/repairman.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Industrial Machine Repairman</a></h4>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/mechanic.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Car Mechanic Right At Home</a></h4>
                                    <p><i class="far fa-map-marker-alt"></i>Rangpur, Bangladesh</p>
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt.</p>
                                    <div class="ads_price_date d-flex justify-content-between">
                                        <span class="price">৳500.00/Hour</span>
                            ...
                            <div class="single_ads_card ads_list d-sm-flex mt-30">
                                <div class="ads_card_image">
                                    <img src="{{asset('assets/frontend/images/ad_photo/bike-mechanic.jpg')}}" alt="ads">
                                    <span><img class="public-market-tag img-fluid" src="{{asset('assets/frontend/images/logo.png')}}"/></span>
                                </div>
                                <div class="ads_card_content media-body">
                                    <div class="meta d-flex justify-content-between">
                                    ...
                                    <h4 class="title"><a href="{{route('frontend.product.details')}}">Bike Mechanic At Home</a></h4>
