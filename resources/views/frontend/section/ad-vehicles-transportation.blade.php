<section class="post_ads_page pt-70 pb-120" id="postVehicles">
    <div class="container">
                    ...
                    <form action="#">
                        ...
                        <div class="form-row">
                            ...
                            <div class="single_form col-lg-4">
                                ...
                                <input type="text" placeholder="Type Trim / Edition (optional)">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="single_form col-lg-4">
                                <label>Year of Manufacture</label>
                                <input type="text" placeholder="Type Year of Manufacture">
                            </div>
                            <div class="single_form col-lg-4">
                                <label>Kilometers run (km)</label>
                                <input type="text" placeholder="Type Kilometers run (km)">
                            </div>
                            <div class="single_form col-lg-4">
                                <label>Engine capacity (cc)</label>
                                <input type="text" placeholder="Type Engine capacity (cc)">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="single_form col-lg-4">
                                <label>Segment</label>
                                <input type="text" placeholder="Type Segment">
                            </div>
                            <div class="single_form col-lg-4">
                                <label>Wheel Size</label>
                                <input type="text" placeholder="Type Wheel Size">
                            </div>
                            <div class="single_form col-lg-4">
                                <label>Color</label>
